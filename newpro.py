...
icon = Image.open("C:\\Users\\Sathya\\Downloads\\Project\\Capestone4\\Airbnb.webp")
...
df = pd.read_csv('C:\\Users\\Sathya\\Downloads\\Project\\Capestone4\\airbnb.csv')

# HOME PAGE
if selected == "Home":
    # Title Image
    st.image("C:\\Users\\Sathya\\Downloads\\Project\\Capestone4\\Home.png")
    ...
    col2.markdown("#   ")
    col2.markdown("#   ")
    col2.image("C:\\Users\\Sathya\\Downloads\\Project\\Capestone4\\Home.jpg")
...
if selected == "Explore":
    ...
    with col1:
        ...
        fig = px.bar(data_frame=pr_df,
                     ...
                     y='price',
                     color='price',
                     title='Avg Price in each room_type'
                    )
        st.plotly_chart(fig,use_container_width=True)
